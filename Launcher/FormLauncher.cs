...
namespace ProjectStellar.FormLauncher
{
    public partial class Launcher : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //2560 * 1440
            //3840 * 2160
            Resolution[] allResolutions = new Resolution[6];
            ...
            allResolutions[3] = new Resolution() { X = 1920, Y = 1080 };
            allResolutions[4] = new Resolution() { X = 2560, Y = 1440 };
            allResolutions[5] = new Resolution() { X = 3840, Y = 2160 };
